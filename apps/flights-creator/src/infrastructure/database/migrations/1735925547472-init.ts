...
export class Init1735925547472 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "airplane_status" ("id" SERIAL NOT NULL, "status" "public"."airplane_status_status_enum" NOT NULL DEFAULT 'in_parking', "create_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_753576731f4dbdadfd8342a5229" UNIQUE ("status"), CONSTRAINT "PK_4614dd14e626197b5d73feffda4" PRIMARY KEY ("id"))`);
