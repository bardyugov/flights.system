...
export class Init1737311273634 implements MigrationInterface {
    name = 'Init1737311273634'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "qualification" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "airplane_id" integer NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "UQ_3a471b7e503015cf6efe9519004" UNIQUE ("name"), CONSTRAINT "UQ_337c9344679a2824a77c3c89de7" UNIQUE ("airplane_id"), CONSTRAINT "PK_c8244868552c4364a5264440a66" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "employee" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "surname" character varying NOT NULL, "last_name" character varying NOT NULL, "birth_date" TIMESTAMP NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "flights_hours" integer NOT NULL DEFAULT '0', "type" "public"."employee_type_enum" NOT NULL, "password" character varying NOT NULL, "refresh_token" character varying, "statusId" integer, CONSTRAINT "CHK_cc175fbf443529a66dd2a8f411" CHECK ("type" = 'pilot'), CONSTRAINT "PK_3c2bc72f03fd5abbbc5ac169498" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."client_type_enum" AS ENUM('basic', 'priority', 'vip')`);
        await queryRunner.query(`CREATE TABLE "client" ("id" SERIAL NOT NULL, "name" character varying NOT NULL, "surname" character varying NOT NULL, "last_name" character varying NOT NULL, "birth_date" TIMESTAMP NOT NULL, "create_at" TIMESTAMP NOT NULL DEFAULT now(), "type" "public"."client_type_enum" NOT NULL DEFAULT 'basic', "password" character varying NOT NULL, "refresh_token" character varying, CONSTRAINT "PK_96da49381769303a6515a8785c7" PRIMARY KEY ("id"))`);
